...
clientID=sim.simxStart('192.168.56.1',23000,True,True,5000,5)
...
errorCode, leftMotor = sim.simxGetObjectHandle(clientID, 'leftMotor4', sim.simx_opmode_oneshot_wait)
errorCode, rightMotor = sim.simxGetObjectHandle(clientID, 'rightMotor4', sim.simx_opmode_oneshot_wait)
