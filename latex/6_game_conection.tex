...
\end{figure}
\section{連線說明-IPv6}
  設定網路 IPv6 位址，而cda後方的第一個冒號為各自組別，第二個為各自組員順序\\
\begin{figure}[hbt!]
\begin{center}
...
\end{figure}
  ...
  接著在 zmq 的 localhost 處打上組長的 IPv6 位置連線，且按下go之後得在右邊輸入pip install keyboard。\\
\newpage
\begin{figure}[hbt!]
\begin{center}
...
\end{center}
\end{figure}
  最後在瀏覽器輸入 http://[組長 IP 位置]:23020,即可看到組長的場景，並且可以移動。
